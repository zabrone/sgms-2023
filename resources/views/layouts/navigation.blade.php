<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logo1.jpg') }}" alt="Logo" class="block h-9 w-auto fill-current text-gray-800" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('user_support.index')" :active="request()->routeIs('user_support.*')">
                        {{ __('User Support') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('user_support.index')" :active="request()->routeIs('user_support.*')">
                {{ __('User Support') }}
            </x-responsive-nav-link>
        </div>
